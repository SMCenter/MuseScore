#ifndef LIVEBRAILLEPREFERENCESMODEL_H
#define LIVEBRAILLEPREFERENCESMODEL_H
...
class LiveBraillePreferencesModel : public QObject
{
    Q_OBJECT
...
#endif // LIVEBRAILLEPREFERENCESMODEL_H
